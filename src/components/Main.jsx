        ...
        <div className="container-fluid main-section bg-dark p-0 m-0">
            ...
            >
                <div className="col d-flex flex-col justify-content-center align-items-center my-auto absolute">
                    ...
                    <p className='fw-normal mt-4 text-white'>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <p className='fw-normal mb-4  text-white'>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
